...
function carViewed() {
    var d = new Date();
    var query = "MERGE (n:Statistic { day: " + d.getDate() + ", month: " + (d.getMonth() + 1) + ", year: " + (d.getYear() + 1900) + "}) ON CREATE SET n.carsviewed = 0, n.carsbought = 0 ON MATCH SET n.carsviewed = n.carsviewed + 1;";
    db.cypher({ query: query});
}

function carBought() {
    var d = new Date();
    var query = "MERGE (n:Statistic { day: " + d.getDate() + ", month: " + (d.getMonth() + 1) + ", year: " + (d.getYear() + 1900) + "}) ON CREATE SET n.carsviewed = 0, n.carsbought = 0 ON MATCH SET n.carsbought = n.carsbought + 1;";
    db.cypher({ query: query});
}
